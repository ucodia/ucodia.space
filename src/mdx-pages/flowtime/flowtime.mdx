import FlowtimeWatch from "./flowtime-watch"
...
<p className="text-center italic text-sm">hold down button for a reality check</p>
...
The original version of flowtime used different algorithms. Random numbers were generated using two separarate linear congruential generators and a less efficient algorithm to shuffle sequences. This initial integration in the watch firmware resulted in draining the watch battery in less than 6 months and prompted for a redesign.
